...
public class RequestManager<T> {
    ...
    public static final String LIVE_BASEFEED_URL = "https://api.github.com/";
...
//        }
        ...
        if (null != Macros.getLoginAuth(mCtx)) {
            HashMap<String, String> headers = new HashMap<String, String>();
            headers.put(Constants.AUTHORIZATION, "Bearer " + Macros.getLoginAuth(mCtx));
            jsObjRequest.setHeaders(headers);
        }
